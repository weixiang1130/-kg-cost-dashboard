...
CATEGORY_MAP = [
    ...
    # 順序對齊人工造價分析表（P6 範本）：粉光在前、壓送在後
    ('參、結構工程','六','整體粉光(含混凝土標高器工料)',['C.05.01.00','C.05.02.00','C.05.00.00'],False,'qty'),
    ('參、結構工程','七','混凝土壓送及澆置',['C.04.02.00'],False,'qty'),
...
PREFIX_RULES = [
    ...
    ('C.03','參、結構工程','e'),('C.04.02','參、結構工程','七'),('C.04','參、結構工程','五'),
    ('C.05','參、結構工程','六'),('C.06','參、結構工程','八'),('C.07','參、結構工程','四'),
